...
Thread::Thread(char *threadName, int prior, int burst) {
...
//----------------------------------------------------------------------
void Thread::setPriority(int prior) { priority = prior; }

//----------------------------------------------------------------------
// Thread::setQuantum
//----------------------------------------------------------------------
void Thread::setQuantum(int q) { quantum = q; }

//----------------------------------------------------------------------
// Thread::decrementQuantum
//----------------------------------------------------------------------
int Thread::decrementQuantum() {
  --quantum;
  return quantum;
}
...
//----------------------------------------------------------------------
void Thread::Interrupt() { interrupted = true; }
...
void Thread::Yield() {
  ...
  if (nextThread != this && nextThread != NULL) {
    scheduler->Run(nextThread);
  }
  (void)interrupt->SetLevel(oldLevel);
}
