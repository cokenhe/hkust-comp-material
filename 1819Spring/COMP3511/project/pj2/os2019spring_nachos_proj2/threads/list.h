...
public:
  ListElement(T itemPtr, int sortKey); // initialize a list element
...
public:
  ...
  T Peek();             // Return but don't remove front of list
  ...
  T SortedPeek(int *keyPtr);              // Return first item from list
