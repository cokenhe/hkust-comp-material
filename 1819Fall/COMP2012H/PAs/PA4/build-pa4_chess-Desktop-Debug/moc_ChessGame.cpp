...
#include "../pa4_chess_skeleton/src/ChessGame.h"
...
QT_MOC_LITERAL(1, 10, 16), // "processUserInput"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 3), // "row"
QT_MOC_LITERAL(4, 32, 3) // "col"

    },
    "ChessGame\0processUserInput\0\0row\0col"
};
...
void ChessGame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ChessGame *_t = static_cast<ChessGame *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->processUserInput((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    }
}
...
QT_INIT_METAOBJECT const QMetaObject ChessGame::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ChessGame.data,
      qt_meta_data_ChessGame,  qt_static_metacall, nullptr, nullptr}
};
