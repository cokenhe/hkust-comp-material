(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[59],{"+dCS":function(e,o,c){"use strict"
c.d(o,"a",(function(){return r}))
var t=c("ouhR")
var l=c.n(t)
...
return o}resize_tool_content_wrapper(e,o){let c=e
"number"!==typeof c&&(c=this.minToolHeight)
const t=o||this.tool_content_wrapper()
t.height(!e||this.minToolHeight>c?this.minToolHeight:c)}}},"0YqI":function(e,o,c){"use strict"
c.r(o)
c.d(o,"whitelist",(function(){return t}))
const t=["requestFullWindowLaunch","lti.resourceImported"]},"4bdt":function(e,o,c){"use strict"
var t=c("pQTu")
var l=c("m0r6")
...
return o}(p)},"9cv0":function(e,o,c){var t={"./__tests__/handleLtiPostMessages.test.js":["Af1U",686],"./__tests__/lti.resourceImported.test.js":["yySz",624],"./__tests__/requestFullWindowLaunch.test.js":["w8Zi",625],"./handleLtiPostMessage.js":["y+46"],"./lti.resourceImported.js":["75OS",687],"./messageTypes.js":["0YqI"],"./requestFullWindowLaunch.js":["S3m7",688]}
...
l.id="9cv0"
e.exports=l},Doqt:function(e,o,c){"use strict"
...
var r=c("ouhR")
var n=c.n(r)
function a(e){let o=e.tool,c=e.placement,r=e.acceptedResourceTypes,a=e.targetResourceType,_=e.allowItemSelection,s=e.selectableItems,i=e.onDismiss,d=e.open
const u={com_instructure_course_accept_canvas_resource_types:r,com_instructure_course_canvas_resource_type:a,com_instructure_course_allow_canvas_resource_selection:_,com_instructure_course_available_canvas_resources:s,display:"borderless",placement:c}
const p=-1===(null===o||void 0===o?void 0:o.base_url.indexOf("?"))?"?":"&"
const k="".concat(null===o||void 0===o?void 0:o.base_url).concat(p).concat(n.a.param(u))
const b=o?o.title:""
return Object(t["a"])(l["a"],{open:d,label:b,onDismiss:i,placement:"end",size:"regular",padding:"0",headerPadding:"small"},void 0,Object(t["a"])("iframe",{style:{border:"none",display:"block",width:"100%",height:"100%"},"data-testid":"ltiIframe",src:k,title:b,"data-lti-launch":"true"}))}},MdYG:function(e,o,c){"use strict"
var t=c("pQTu")
var l=c("m0r6")
...
if(!isNaN(c))return b(c,o)}return e}},uErj:function(e,o,c){"use strict"
c.d(o,"a",(function(){return p}))
var t=c("ouhR")
var l=c.n(t)
c("MWZS")
var r=c("5Ky4")
...
for(let c=0;c<o.length;c+=1)if(o[c].contentWindow===e)return o[c]
return null}function u(e){if(e.data.source&&"react-devtools-bridge"===e.data.source)return
if(e.data.messageType){Object(a["default"])(e)
return}try{const c=JSON.parse(e.data)
switch(c.subject){case"lti.frameResize":const t=new n["a"]
var o=c.height
o<=0&&(o=1)
const a=t.tool_content_wrapper(c.token||e.origin).data("height_overridden",true)
if(a.length>0)t.resize_tool_content_wrapper(o,a)
else{const c=d(e.source)
if(c){"number"===typeof o&&(o+="px")
c.height=o
c.style.height=o}}break
case"lti.fetchWindowSize":{const o=d(e.source)
if(o){c.height=window.innerHeight
c.width=window.innerWidth
c.offset=l()(".tool_content_wrapper").offset()
c.footer=l()("#fixed_bottom").height()||0
c.scrollY=window.scrollY
const e=JSON.stringify(c)
o.contentWindow.postMessage(e,"*")}break}case"lti.showModuleNavigation":true!==c.show&&false!==c.show||l()(".module-sequence-footer").toggle(c.show)
break
case"lti.scrollToTop":l()("html,body").animate({scrollTop:l()(".tool_content_wrapper").offset().top},"fast")
break
case"lti.setUnloadMessage":s(Object(r["a"])(c.message))
break
case"lti.removeUnloadMessage":i()
break
case"lti.screenReaderAlert":l.a.screenReaderFlashMessageExclusive(c.body.html||c.body)
break
...
o.contentWindow.postMessage(e,"*")})},false)}break}}}catch(e){(console.error||console.log).call(console,"invalid message received from")}}function p(){window.addEventListener("message",e=>{""!==e.data&&u(e)})}},veHt:function(e,o,c){"use strict"
var t=c("pQTu")
var l=c("m0r6")
...
return e},{}),releasedAssignments:e.reduce((e,o)=>{o.scoring_ranges.forEach(c=>{c.assignment_sets.forEach(t=>{t.assignments.forEach(t=>{const l=t.assignment_id
e[l]=e[l]||[]
...
o["a"]={isEnabled:a,reloadEnv(){s=_()},getItemData(e){let o=!(arguments.length>1&&void 0!==arguments[1])||arguments[1]
e=e&&e.toString()
return a()?{isCyoeAble:e&&o,isTrigger:e&&o&&i(e),isReleased:d(e),releasedLabel:u(e)}:{}}}},"y+46":function(e,o,c){"use strict"
c.r(o)
c.d(o,"ltiState",(function(){return l}))
var t=c("0YqI")
const l={}
const r=async e=>{const o=e.data,l=o.messageType,r=o.data
let n
if(!t["whitelist"].includes(l)){console.error("invalid messageType: ".concat(l))
return false}try{const e=await c("9cv0")("./".concat(l,".js"))
n=e.default
n(r)
return true}catch(e){console.error('Error loading or executing message handler for "'.concat(l,'"'),e)}}
o["default"]=r}}])

//# sourceMappingURL=59-c-af0d7bc21a.js.map